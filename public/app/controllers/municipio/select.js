angular.module('myApp').controller('SelectMunicipioController', ['$http', '$scope', '$location', '$q', '$timeout', 'NavigationService', 'MunicipioService', function ($http, $scope, $location, $q, $timeout, NavigationService, MunicipioService) {
	$scope.dataList = [];
