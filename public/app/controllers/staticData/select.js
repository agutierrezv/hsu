angular.module('myApp').controller('SelectStaticDataController', ['$http', '$scope', '$location', '$q', '$timeout', 'NavigationService', 'StaticDataService', function ($http, $scope, $location, $q, $timeout, NavigationService, StaticDataService) {
	$scope.dataList = [];
